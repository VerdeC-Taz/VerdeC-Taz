		...
		void export_high_pop_countries()
{
	...
	outfile.close();
     ...
     class searchEngine: public country{
       	private:
       		int choice;
       		string query;
       	public:
...
int countryindex(string country)
{
	...
	return -1;
       		...
       		cin>>choice;
       	//	cin.ignore();//to remove enter which is space so that get line can work
       		switch(choice){
...
class analysisEngine:public country,public searchEngine{
	public:
void minMax()
{
